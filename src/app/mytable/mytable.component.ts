...
export class MytableComponent implements OnInit {
  ...
  constructor(private httpclient:HttpClient) {
    ...
    this.httpclient.get('http://0.0.0.0:5000/getall')
    .toPromise()
    .then(response => {
...
export class ButtonViewComponent implements ViewCell, OnInit {
  ...
  onClick() {
    ...
    {
      this.httpclient.post('http://0.0.0.0:5000/make_user',{'username':this.rowData.username})
      .toPromise()
      .then(response => {
    ...
    {
      this.httpclient.post('http://0.0.0.0:5000/make_admin',{'username':this.rowData.username})
      .toPromise()
      .then(response => {
...
export class ButtonViewComponent2 implements ViewCell, OnInit {
  ...
  onClick() {
    ...
    {
      this.httpclient.post('http://0.0.0.0:5000/make_in_active',{'username':this.rowData.username})
      .toPromise()
      .then(response => {
    ...
    {
      this.httpclient.post('http://0.0.0.0:5000/make_active',{'username':this.rowData.username})
      .toPromise()
      .then(response => {
